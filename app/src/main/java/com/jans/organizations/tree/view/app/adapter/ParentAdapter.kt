...
import com.jans.organizations.tree.view.app.utils.VerticalLineView


class ParentAdapter(private val products: List<Parent>) :
        ...
        if (isExpanded) {
            ...
            relView.setOnClickListener {
                ...
                if (isRV) {
                    ...
                    linearLayout.layoutParams.height = holder.rvChildrenList.layoutParams.height
    ...
    class ParentViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        var relChildren = itemView.findViewById(R.id.relChild) as RelativeLayout
