...
class AncestorNineAdapterOrganization(private val newItemList: List<OrganizationItems>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
...
//                    parentRV.layoutManager = parentRVLayoutManager
                    val adapter = AncestorNineAdapterOrganization(childrenList)
