...
class AncestorSixAdapterOrganization(private val newItemList: List<OrganizationItems>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
        ...
        when (holder) {
            is ParentViewHolder -> {
                ...
                if(childrenList.isEmpty()){
                    ...
                    val adapter = AncestorSixAdapterOrganization(childrenList)
